...
class VideoCallAccepted implements ShouldBroadcast
{
    ...
    {
        $this->videoCall->load(['room', 'conversation', 'initiator', 'accepter']);
        ...
        return [
            ...
            'accepted_by' => $this->videoCall->accepted_by,
            'accepted_at' => $this->videoCall->accepted_at?->toISOString(),
            'room_url' => $this->videoCall->room->room_url,
            'initiator_name' => $this->videoCall->initiator->name ?? 'Unknown',
            'accepter_name' => $this->videoCall->accepter->name ?? 'Unknown'
        ];
    }
}
